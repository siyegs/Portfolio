...
const projects = [
  ...
  ["expo-ota-guard", "expo-ota-guard", "Open-source zero-config CLI that answers one question before an Expo OTA: is this change safe to ship over the air, and to which live runtime? Classifies native-affecting versus OTA-safe changes, reads live runtimes from eas update:list, and gates CI."],
